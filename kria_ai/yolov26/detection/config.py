...
MODELS = {
    ...
    "yolov26n_FaceHuman": DetectionModelConfig(
        id="yolov26n_facehuman",
        name="YOLO26n Face Human",
        checkpoint_path=Path("models/yolov26n_2classes.pt"),
        repository_path=Path("models/ultralytics-main"),
...
DATASETS = {
    "coco": DetectionDatasetConfig(
        ...
        train_images=Path("data/openimagesv7/train2017"),
        validation_images=Path("data/openimagesv7/val2017"),
    ...
    "openimagesv7": DetectionDatasetConfig(
        id="openimagesv7",
        name="Open Images V7 Face Human Detection",
        train_images=Path("data/openimagesv7/train/images"),
        validation_images=Path("data/openimagesv7/validation/images"),
        train_labels=Path("data/openimagesv7/train/labels"),
        validation_labels=Path("data/openimagesv7/validation/labels"),
        subset_cache_dir=Path("data/openimagesv7/.subsets/detection"),
        board_images=Path("datasets/openimagesv7"),
